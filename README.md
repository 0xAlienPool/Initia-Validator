...
Register here ⬇️ https://contabo.com/en/vps/
...
```bash
curl -o install_initia.sh curl -o install_initia.sh https://raw.githubusercontent.com/0xAlienPool/Initia_Validator/main/install_initia.sh
